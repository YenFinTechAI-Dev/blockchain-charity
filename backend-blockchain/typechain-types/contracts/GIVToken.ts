...
export interface GIVTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface GIVToken extends BaseContract {
  connect(runner?: ContractRunner | null): GIVToken;
  waitForDeployment(): Promise<this>;

  interface: GIVTokenInterface;
